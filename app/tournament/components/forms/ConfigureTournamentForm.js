                    ...
                    <div className="panel-heading">
                        <Row>
                            <Col md={12}>
                                ...
                                <ButtonGroup>
                                    <Button onClick={this.createTournamentTable} bsStyle="info" bsSize="large">Create Tournament</Button>
                                    <Button onClick={this.startTournament} bsStyle="info" bsSize="large">Setup tournament bracket</Button>
                                </ButtonGroup>
                            </Col>
                        </Row>
                    </div>

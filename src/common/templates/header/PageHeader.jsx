    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li>
            <Link to="gettingstarted" activeClassName="selected">
              Getting started
            </Link>
          </li>
          {/*
          ...
          */}
          <li>
            <Link to="viewgame" activeClassName="selected">
              Games
            </Link>
          </li>
          {loggedIn ? (
            <li>
              <Link to="tournament" activeClassName="selected">
                Tournament
              </Link>
            </li>
          ) : null}
          {loggedIn ? (
            ...
            <li>
              <Link to="auth" activeClassName="selected">
                Log in
              </Link>
            </li>
          )}
